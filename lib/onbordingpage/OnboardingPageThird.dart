...
class OnboardingPageThird extends StatelessWidget {
  final List<Map<String, String>> fitnessGoals = [
    {
      'title': 'Toned',
      'image': 'assets/images/f3img1.png', // replace with actual image path
    },
    {
      'title': 'Well-built',
      'image': 'assets/images/f3img2.png', // replace with actual image path
    },
    {
      'title': 'Muscle mass',
      'image': 'assets/images/f3img3.png', // replace with actual image path
    },
  ];
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: CustomText(
                  text: DemoLocalization.of(context)!.translate('Whatisyourfitnesslevel').toString(),//"Goal body type?",
                  fontSize: 7.0,
