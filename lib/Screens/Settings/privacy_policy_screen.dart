            ...
            children: [
              Padding(
                ...
                child: CstAppbarWithtextimage(
                    title: DemoLocalization.of(context)!.translate('PrivacyPolicy').toString(),
              ...
              Obx(
                 () {
                   ...
                   if (settingController.privacyData.isEmpty) {
                     return  Center(
                   ...
                   return
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        CustomText(text:"${settingController.privacyData.first.title}", fontSize: 4, color:FitnessColor.primary,fontWeight: FontWeight.bold, fontFamily: Fonts.arial,),
                        const SizedBox(height: 5,),
                        CustomText(text:"${settingController.privacyData.first.content}", fontSize: 4, color:FitnessColor.primary,textAlign: TextAlign.justify,fontFamily: Fonts.arial, ),
                      ],
                    ),
                  );
                }
